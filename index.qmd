...
## {background-image="figures/hero-title-bg.webp" background-size="cover" background-position="center"}

::: {style="display:flex; justify-content:flex-end; align-items:center; min-height:80vh; padding-right:calc(13% - 70px);"}
::: {style="width: 62%; text-align: right;"}
<span style="color:#15324c; font-size:210%; font-weight:bold; line-height:1.12; display:block;">It's (still) very bad to be wrong</span>

<span style="color:#2b4a64; display:block; margin-top:0.7em;">Agents for Correct, Transparent, and Reproducible Data Analysis</span>

<br>
<br>

<span style="color:#15324c; display:block;">_Sara Altman & Simon Couch_</span>
<span style="color:#2b4a64; display:block;">AI Core Team @ Posit</span>
:::
:::
