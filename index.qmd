...
::: {style="display: inline-block; text-align: left; font-size: 1.05em; line-height: 1.9; margin-top: 50px;"}
[1. Tell them to care about being right]{.fragment .semi-fade-out data-fragment-index="1"}

[2. Design the scaffold so that it matters less if they're wrong]{.fragment  .toc-emph data-fragment-index="1"}
:::
...
* LLMs are aliens 
* But they are still useful for data analysis
  * Tell them to care about correctness
  * Design the scaffold so it doesn't matter if they listen
    * Make them write code in the same environment as the user and show it to them
