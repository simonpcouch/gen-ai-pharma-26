...
::: {style="display: flex; align-items: flex-end; padding-bottom: 60px; font-size: 2.5em; color: #888;"}
⟵
:::

::: {style="flex: 2; display: flex; flex-direction: column; gap: 0px; justify-content: flex-end; padding-bottom: 40px; border-left: 2px dashed #bbb; padding-left: 24px;"}
