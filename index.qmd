...
::: {.fragment style="background-color: #f9e6b5; border-radius: 18px; padding: 18px 32px; box-shadow: 0 4px 16px rgba(0,0,0,.2);"}
[_Part I_]{style="color: #ee6331; font-weight: 700; font-size: 0.9em;"}<br>
[LLMs are aliens]{style="color: #ee6331; font-weight: 700; font-size: 1.4em;"}

::: {style="color: #447099; font-size: 0.95em; margin-top: 10px; line-height: 1.5;"}
...
::: {.fragment style="background-color: #f9e6b5; border-radius: 18px; padding: 18px 32px; box-shadow: 0 4px 16px rgba(0,0,0,.2);"}
[_Part II_]{style="color: #ee6331; font-weight: 700; font-size: 0.9em;"}<br>
