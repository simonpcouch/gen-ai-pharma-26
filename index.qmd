...
![](figures/posit-assistant.png){fig-align="center" width="820" style="border-radius: 10px; box-shadow: 0 4px 14px rgba(0,0,0,0.18);"}
...
to keep analysis **correct · reproducible · transparent**
:::
...
→ keeps it **reproducible** and **transparent**
:::
